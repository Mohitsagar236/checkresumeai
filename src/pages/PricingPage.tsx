      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="relative z-10 text-center mb-16">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-blue-500/10 dark:bg-blue-500/20 rounded-full blur-3xl -z-10"></div>
            <div className="absolute top-10 right-0 w-40 h-40 bg-purple-500/10 dark:bg-purple-500/20 rounded-full blur-3xl -z-10"></div>

            <span className="inline-block px-3 py-1 mb-3 text-xs font-medium text-blue-700 bg-blue-100 dark:text-blue-300 dark:bg-blue-900/40 rounded-full">
              Pricing Plans
            </span>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-violet-600 dark:from-blue-400 dark:to-violet-400 bg-clip-text text-transparent mb-4">Simple, Transparent Pricing</h1>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Choose the plan that suits your needs, upgrade or downgrade anytime
            </p>

            <div className="flex items-center justify-center mt-10">
              <div className="relative bg-white dark:bg-slate-800 p-1 rounded-lg inline-flex shadow-md">
                {/* Animated highlight pill */}
                <div className={`absolute inset-0 h-full rounded-lg transition-all duration-300 ease-out ${billingCycle === 'monthly'
                  ? 'transform translate-x-0 w-1/2 bg-gradient-to-r from-blue-500/10 to-violet-500/10'
                  : 'transform translate-x-full w-1/2 -translate-x-full bg-gradient-to-r from-violet-500/10 to-blue-500/10'
                  }`}></div>
                <button
                  className={`relative z-10 px-6 py-3 rounded-md text-sm font-medium transition-all duration-300 ${billingCycle === 'monthly'
                ...
                <button
                  className={`relative z-10 px-6 py-3 rounded-md text-sm font-medium transition-all duration-300 ${billingCycle === 'yearly'
                    ? 'text-blue-600 dark:text-blue-400'
                    : 'text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-neutral-100'
                    }`}
                ...
                >
                  Yearly
                  <span className="ml-2 px-2 py-0.5 text-xs bg-green-100 text-green-700 dark:bg-green-900/60 dark:text-green-400 font-semibold rounded-full">Save 58%</span>
                </button>
              </div>
            </div>
          </div>
              ...
              .map(plan => (
                ...
                >
                  ...
                  <CardFooter className="pt-6">
                    ...
                    </Button>                    <p className="text-xs text-center text-gray-500 dark:text-gray-400 mt-4">
                      {plan.id.includes('premium')
                        ? 'All sales are final'
          ...
          <div className="mt-24 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              />              <FaqCard
                ...
                answer="All sales are final. We encourage you to carefully review our subscription options before completing your purchase to ensure it meets your needs."
                icon="shield"
              />
          ...
          <div className="mt-24 relative overflow-hidden rounded-2xl shadow-lg dark:shadow-slate-900/40">
            ...
            <div className="relative z-10 p-12 text-center">
              ...
              <div className="mt-10 flex items-center justify-center text-sm text-white/70">                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
                Secured with 256-bit encryption. Trusted by thousands of job seekers.
              </div>
            </div>
          </div>
        </div>
