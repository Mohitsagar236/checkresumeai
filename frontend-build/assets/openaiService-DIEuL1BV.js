import{d as S}from"./api-auth-Bg8EMeB_.js";import{S as f}from"./groqService-B2tCXVZo.js";import{M as i}from"./heavy-pages-DCVTemLh.js";import"./vendor-tXTmRvck.js";import"./react-vendor-Dk2H9M6Y.js";import"./utilities-B_Cdbyew.js";import"./pdfjs-CtqWcUnV.js";import"./ui-components-Bmi50208.js";const O="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",I="https://openrouter.ai/api/v1",A=async(n,c)=>{var o;console.log("[OpenRouter Service] Analyzing resume with OpenRouter API...");try{const r=n.text,u=n.sections,g=Object.entries(u).filter(([,s])=>s!==void 0&&s!=="").map(([s,e])=>`${s}: ${e}`).join(`
