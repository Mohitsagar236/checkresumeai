import{b as S}from"./api-auth-4AoI1hlY.js";import{S as I,A}from"./groqService-CdbUiQBS.js";import{N as r}from"./heavy-pages-BYFs328K.js";import"./vendor-CY3E3muA.js";import"./utilities-y38mOQer.js";import"./react-vendor-Tecco6n4.js";import"./pdfjs-Cev1TANf.js";import"./ui-components-DJA5pO2r.js";const f=async(n,c)=>{var o;console.log("[OpenAI Service] Analyzing resume with OpenAI API...");try{const i=n.text,u=n.sections,g=Object.entries(u).filter(([,s])=>s!==void 0&&s!=="").map(([s,e])=>`${s}: ${e}`).join(`
