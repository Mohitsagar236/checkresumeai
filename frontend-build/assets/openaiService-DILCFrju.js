import{b as S}from"./api-auth-BfUi6chK.js";import{S as f}from"./groqService-C2pnjqaP.js";import{M as i}from"./heavy-pages-wyC4t00o.js";import"./vendor-Bd9Ddrv3.js";import"./utilities-ChGytp73.js";import"./react-vendor-BtjJbRek.js";import"./pdfjs-Cev1TANf.js";import"./ui-components-b-5w5n6D.js";const O="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",I="https://openrouter.ai/api/v1",A=async(n,c)=>{var o;console.log("[OpenRouter Service] Analyzing resume with OpenRouter API...");try{const r=n.text,u=n.sections,g=Object.entries(u).filter(([,s])=>s!==void 0&&s!=="").map(([s,e])=>`${s}: ${e}`).join(`
