import{d as S}from"./api-auth-gZcOLl8A.js";import{S as f}from"./groqService-CfvTw93y.js";import{M as i}from"./heavy-pages-IXnjnBRi.js";import"./vendor-CmhHl421.js";import"./react-vendor-DU2VrNI_.js";import"./ui-components-CYzXEEww.js";import"./pdfjs-CtqWcUnV.js";const O="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",I="https://openrouter.ai/api/v1",A=async(n,c)=>{var o;console.log("[OpenRouter Service] Analyzing resume with OpenRouter API...");try{const r=n.text,u=n.sections,g=Object.entries(u).filter(([,s])=>s!==void 0&&s!=="").map(([s,e])=>`${s}: ${e}`).join(`
