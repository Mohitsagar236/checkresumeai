import{d as S}from"./api-auth-fNXa73Cf.js";import{S as f}from"./groqService-CEtpuUeJ.js";import{M as i}from"./heavy-pages-CO63xO5Y.js";import"./vendor-DucoW7vq.js";import"./react-vendor-C6Yq2cd9.js";import"./ui-components-cWpqF8TB.js";import"./pdfjs-CtqWcUnV.js";import"./routing-BX7cfslS.js";const O="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",I="https://openrouter.ai/api/v1",A=async(n,c)=>{var o;console.log("[OpenRouter Service] Analyzing resume with OpenRouter API...");try{const r=n.text,u=n.sections,g=Object.entries(u).filter(([,s])=>s!==void 0&&s!=="").map(([s,e])=>`${s}: ${e}`).join(`
