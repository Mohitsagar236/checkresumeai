...
router.post('/analyze', upload.single('resume'), asyncHandler(async (req, res) => {
    if (!req.file) {
...
router.post('/compare', premiumMiddleware, asyncHandler(async (req, res) => {
...
router.post('/batch-analyze', premiumMiddleware, upload.array('resumes', 5), asyncHandler(async (req, res) => {
